...
link = "https://apnews.com/hub/us-news?utm_source=apnewsnav&utm_medium=navigation"
...
try:
    ...
    print('URL Broken')
    obj_list = [{'type':'Headline','source':'AP US', 'title': 'Link Broken', 'link': '', 'Notes': '', 'date': ''}]
...
for item in soup.find_all(class_='CardHeadline'):
    ...
    obj_data = {'type':'Headline','source':'AP US', 'title': title, 'link': ilink, 'Notes': 'notes', 'date': 'idate'}
    object_list.append(obj_data)

## Final dataframe is defined
apus_df = pd.DataFrame(object_list).head(8)
