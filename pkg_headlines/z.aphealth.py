...
def aphealth_scrape():
    ...
    try:
        ...
        print('URL Broken')
        obj_list = [{'type':'Headline','source':'AP Health', 'title': 'Link Broken', 'link': '', 'Notes': '', 'date': ''}]
    ...
    for item in soup.find_all(class_='Component-headline-0-2-105'):
        ...
        obj_data = {'type':'Headline','source':'AP Health', 'title': title, 'link': ilink, 'Notes': 'notes', 'date': 'idate'}
